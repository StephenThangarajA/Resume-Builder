...
const HowToDownload = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-blue-200 p-8">
      <Link to="/create" className="mb-6">
        <Button className="text-white bg-blue-700 hover:bg-blue-600 transition duration-300">
          Back
        </Button>
      </Link>
